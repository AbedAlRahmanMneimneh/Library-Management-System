...
CREATE TABLE `wrote` (
  ...
  KEY `ISBNo` (`ISBN`),
  KEY `author` (`authorId`),
  CONSTRAINT `author` FOREIGN KEY (`authorId`) REFERENCES `author` (`authorId`),
  CONSTRAINT `ISBNo` FOREIGN KEY (`ISBN`) REFERENCES `book` (`ISBN`)
...
-- Dump completed on 2023-12-11  1:08:48
